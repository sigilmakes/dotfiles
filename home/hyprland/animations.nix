# Hyprland animations — tuned for Caelestia shell.
#
# Matching the animation curves from Caelestia's reference config
# for a cohesive feel between shell transitions and window animations.
